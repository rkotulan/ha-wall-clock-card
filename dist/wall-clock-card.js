                                ...
                                <div class="row">
                                    ...
                                    <div class="value">
                                        <ha-textfield
                                                ...
                                                @input=${e=>{e.stopPropagation(),e.preventDefault();const t=e.target;if(!t||!this._config)return;const i=JSON.parse(JSON.stringify(this._config));let s="string"==typeof t.value?parseInt(t.value,10):t.value;s=Math.max(s||30,1);const o=60*s;i.weatherUpdateInterval=o,this._config=i,We(this,"config-changed",{config:i})}}
                                        ></ha-textfield>
                                        <span>minutes</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="value">
                                    <ha-textfield
                                            ...
                                            @input=${e=>{e.stopPropagation(),e.preventDefault();const t=e.target;if(!t||!this._config||!this._config.transportation)return;const i=JSON.parse(JSON.stringify(this._config));let s="string"==typeof t.value?parseInt(t.value,10):t.value;s=Math.max(s||1,1);const o=60*s;i.transportationUpdateInterval=o,this._config=i,We(this,"config-changed",{config:i})}}
                                    ></ha-textfield>
                                    <span>minutes</span>
                                </div>
                            </div>
