    ...
    `}renderWeatherContent(){var e;if(this.weatherError)return M`<div class="weather-error">${this.weatherErrorMessage}</div>`;if(!this.weatherData||!this.weatherData.current)return M`<div class="weather-loading">Loading weather data...</div>`;const t=this.config.weatherDisplayMode||"both",i=this.config.weatherForecastDays||3,s=this.config.weatherTitle||"Weather",o=Math.min(i,this.weatherData.daily.length);return M`
      ...
      ${"current"===t||"both"===t?M`
          <div class="weather-current">
            ...
            <div class="weather-condition">${function(e,t){var i;if(!["cs","de","sk","pl","es","fr"].includes(t))return e;const s=e.toLowerCase();return"few clouds"===s||"scattered clouds"===s||"broken clouds"===s?be.clouds[t]:"thunderstorm"===s||"shower rain"===s?be.rain[t]:(null===(i=be[s])||void 0===i?void 0:i[t])||e}(this.weatherData.current.condition,(null===(e=this.config.weatherConfig)||void 0===e?void 0:e.language)||"cs")}</div>
          </div>
        `:""}
