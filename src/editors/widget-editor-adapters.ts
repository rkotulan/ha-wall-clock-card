    ...
    switch (widget.type) {
        ...
        case 'weather':
            return defined({
                ...
                showTitle: editorConfig.weatherShowTitle,
                ...
                showIcons: editorConfig.weatherShowIcons,
                forecastDateGap: editorConfig.forecastDateGap,
                orientation: widget.orientation,
            }) as WidgetConfig;
        case 'transportation': {
...
export function fromBackgroundEditorConfig(editorConfig: EditorConfig): BackgroundConfig {
    return defined({
        ...
        transparent: editorConfig.backgroundTransparent,
        color: editorConfig.backgroundColor,
